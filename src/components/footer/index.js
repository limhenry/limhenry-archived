			...
			<div class={style.footer}>
				...
				<div class={style.footer_social}>
					<a aria-label="Twitter" href="https://twitter.com/henrylim96" target="_blank" rel="noopener">
						<svg>
							<g>
								<path d="M1,18.9c1.94,1.23,4.17,2.22,7.25,2.09c7.46-0.34,12.46-5.69,12.57-13.51C21.62,6.8,22.57,6,23,5.1
					...
					<a aria-label="Dribbble" href="https://dribbble.com/henrylim96" target="_blank" rel="noopener">
						<svg>
							<g>
								<path d="M12,4c4.41,0,8,3.59,8,8s-3.59,8-8,8s-8-3.59-8-8S7.59,4,12,4 M12,2C6.48,2,2,6.48,2,12s4.48,10,10,10 c5.52,0,10-4.48,10-10S17.52,2,12,2L12,2z"></path> </g> <g> <path d="M15.27,20.25c-0.01-0.05-1-5.21-2.62-8.51c-1.64-3.36-4.5-7.48-4.53-7.53l1.64-1.14c0.12,0.17,2.97,4.29,4.68,7.79 c1.74,3.54,2.74,8.8,2.79,9.02L15.27,20.25z"></path> </g> <g> <path d="M3.18,11.71c-0.14,0-0.22,0-0.25,0l0.03-2c0.06,0,5.54,0.06,9.33-1.17c3.62-1.18,5.58-4.01,5.6-4.04l1.65,1.12 c-0.09,0.14-2.37,3.42-6.63,4.82C9.24,11.64,4.35,11.71,3.18,11.71z"></path> </g> <g> <path d="M6.67,19.5l-1.62-1.17c0.13-0.19,3.34-4.59,7.4-5.91c4.41-1.43,8.87-0.41,9.06-0.37L21.05,14 c-0.04-0.01-4.12-0.93-7.99,0.32C9.62,15.45,6.7,19.46,6.67,19.5z"></path>
							</g>
						</svg>
					</a>
				</div>
